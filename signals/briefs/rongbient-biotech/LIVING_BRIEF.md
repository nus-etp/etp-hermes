...
- **2025-01-29** — The Fish Site profiled Rongbient's surface-net Gracilaria polyculture model: Cà Mau pilot ponds doubled farmer incomes, ~US$500K in pre-orders, and a US$500K pre-seed raise in progress — [thefishsite.com](https://thefishsite.com/articles/rongbient-shrimp-and-seaweed-a-recipe-for-success-for-vietnam)
  - Summary: The Fish Site's seaweed-industry analyst profiled Rongbient's integrated multi-trophic model: Gracilaria seaweed grown on surface nets atop shrimp ponds acts as biofilter, feed ingredient, and second income stream. As of early 2025 the company ran pilot hectares in Cà Mau (Mekong Delta) that doubled farmer incomes and lifted shrimp survival from 33% to 42%; post-harvest seaweed is processed into a feed additive that cut antibiotic/probiotic usage by 20%. Rongbient held roughly US$500K in pre-orders and was raising a US$500K pre-seed round to scale supply and processing.
  - People: Cuong Ha "CK" (Founder)
  - Counterparties: One of Vietnam's largest shrimp exporters (planned pilot), Cà Mau provincial government (scale-up partner)
  - Numbers: US$500K pre-orders; US$500K pre-seed raise target; shrimp survival 33%→42%; feed-additive use −20%; 3.2%/day seaweed growth rate
  - Quote: "If you can cut 50 percent of those additives, it would mean 10 to 15 percent of the total cost. That is close to a farmer's yearly profit margin." — Cuong Ha (CK), Founder
